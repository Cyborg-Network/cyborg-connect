...
function ServiceCards({logo, title, description = ''}) {
    return (
        <div className='border border-cb-gray-400 rounded-md w-80'>
            <div className='flex flex-col items-center bg-cb-gray-600 h-full justify-between'>
                <a className='pt-10'>
                    <img src={logo} />
                </a>
                ...
                <div className='flex justify-center text-white opacity-50 bg-cb-gray-400 w-full h-14'>
                    <button className='focus:text-cb-green hover:text-cb-green'>
                        <h4>Deploy Now</h4>
                    </button>
                </div>
            </div>
  ...
  return (
    <div className='h-screen bg-cb-gray-700 flex flex-col items-center justify-center'>
        ...
        <div className='flex sm:flex-row flex-col gap-4 p-2'>
            <ServiceCards logo={cyberdock} title='Cyber Dock' description='(deploy docker images at ease)'/>
