...
const UploadDockerImgURL: React.FC<Props> = ({ setService, onCancel, nodes }: Props) => {
  ...
  return (
    ...
    <Modal onOutsideClick={() => onCancel()}>
      ...
      />
      <div>
        <h5 className="flex">{SERVICE_CONTENT[service.id].header}</h5>
        <div className="mb-4">
          <input
            type="text"
            id="url"
            name="url"
            placeholder={SERVICE_CONTENT[service.id].placeholder}
