...
export const GetLogs: React.FC<GetLogsProps> = ({
  link,
  taskId,
  scrollIsAutomated,
  logs,
  ...
  return (
    <code
      ref={scrollRef}
      className="flex justify-between h-full text-opacity-75 text-white bg-color-background-2 bg-opacity-25 w-full rounded-md p-2 overflow-y-scroll"
    >
